...
C              IS COMPUTED WITH HELP OF THE FUNCTION HINIT_dopri5
C
...
C --- INITIAL PREPARATIONS   
      ...
      HMAX=ABS(HMAX)     
      IORD=5  
      IF (H.EQ.0.D0) H=HINIT_dopri5(N,FCN,X,Y,XEND,POSNEG,K1,K2,K3,IORD,
...
C --- FAIL EXIT
 ...
 979  FORMAT(' EXIT OF DOPRI5 AT X=',E18.4) 
      ...
      END
C
      FUNCTION HINIT_dopri5(N,FCN,X,Y,XEND,POSNEG,F0,F1,Y1,IORD,
     &                 HMAX,ATOL,RTOL,ITOL,RPAR,IPAR)
C ----------------------------------------------------------
